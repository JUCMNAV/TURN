...
import org.xtext.project.turn.ide.contentassist.antlr.PartialTurnContentAssistParser;
...
import org.xtext.project.turn.ui.contentassist.TurnProposalProvider;
import org.xtext.project.turn.ui.editor.TurnEditor;
import org.xtext.project.turn.ui.labeling.TurnDescriptionLabelProvider;
import org.xtext.project.turn.ui.labeling.TurnLabelProvider;
import org.xtext.project.turn.ui.outline.TurnOutlineTreeProvider;
import org.xtext.project.turn.ui.quickfix.TurnQuickfixProvider;
import org.xtext.project.turn.validation.TurnValidatorConfigurationBlock;

/**
 * Manual modifications go to {@link TurnUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractTurnUiModule extends DefaultXbaseUiModule {

	public AbstractTurnUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(org.xtext.project.turn.parser.antlr.internal.InternalTurnLexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalTurnLexer.class).toProvider(LexerProvider.create(InternalTurnLexer.class));
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.validation.ValidatorFragment2
	public Class<? extends AbstractValidatorConfigurationBlock> bindAbstractValidatorConfigurationBlock() {
		return TurnValidatorConfigurationBlock.class;
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return TurnLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(TurnDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return TurnOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return TurnQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return TurnProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialTurnContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("Turn Compare");
	}
