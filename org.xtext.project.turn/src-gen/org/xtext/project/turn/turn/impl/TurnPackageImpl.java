...
import org.xtext.project.turn.turn.NoneFeature;
...
public class TurnPackageImpl extends EPackageImpl implements TurnPackage
{
   ...
   * @generated
   */
  private EClass decomposedFeatureEClass = null;
   ...
   * @generated
   */
  private EClass featureModelMainEClass = null;
   ...
   * @generated
   */
  private EClass noneFeatureEClass = null;
   ...
   * @generated
   */
  private EClass xorDecomposedFeatureEClass = null;
   ...
   * @generated
   */
  private EClass orDecomposedFeatureEClass = null;
   ...
   * @generated
   */
  private EClass inclusionFeatureEClass = null;
   ...
   * @generated
   */
  private EClass featureXORDecompositionEClass = null;
   ...
   * @generated
   */
  private EClass featureORDecompositionEClass = null;
  ...
  public static TurnPackage init()
  {
    ...
    Object registeredTurnPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    TurnPackageImpl theTurnPackage = registeredTurnPackage instanceof TurnPackageImpl ? (TurnPackageImpl)registeredTurnPackage : new TurnPackageImpl();
   ...
   * @generated
   */
  public EReference getURNspec_FeatureModels()
  {
   ...
   * @generated
   */
  public EAttribute getFeatureElement_Name()
  {
   ...
   * @generated
   */
  public EClass getDecomposedFeature()
  {
    return decomposedFeatureEClass;
  }
   ...
   * @generated
   */
  public EClass getFeatureModelMain()
  {
    return featureModelMainEClass;
  }
   ...
   * @generated
   */
  public EAttribute getFeatureModelMain_Name()
  {
    return (EAttribute)featureModelMainEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getFeatureModelMain_LongName()
  {
    return (EReference)featureModelMainEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EReference getFeatureModelMain_Root()
  {
    return (EReference)featureModelMainEClass.getEStructuralFeatures().get(2);
  }
   ...
   * @generated
   */
  public EClass getNoneFeature()
  {
    return noneFeatureEClass;
  }
   ...
   * @generated
   */
  public EClass getXORDecomposedFeature()
  {
    return xorDecomposedFeatureEClass;
  }
   ...
   * @generated
   */
  public EReference getXORDecomposedFeature_LinksSrc()
  {
    return (EReference)xorDecomposedFeatureEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EClass getORDecomposedFeature()
  {
    return orDecomposedFeatureEClass;
  }
   ...
   * @generated
   */
  public EReference getORDecomposedFeature_LinksSrc()
  {
    return (EReference)orDecomposedFeatureEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EClass getInclusionFeature()
  {
    return inclusionFeatureEClass;
  }
   ...
   * @generated
   */
  public EReference getInclusionFeature_LinksSrc()
  {
    return (EReference)inclusionFeatureEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EAttribute getInclusion_InclusionType()
  {
    return (EAttribute)inclusionEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getInclusion_Dest()
  {
   ...
   * @generated
   */
  public EClass getFeatureXORDecomposition()
  {
    return featureXORDecompositionEClass;
  }
   ...
   * @generated
   */
  public EReference getFeatureXORDecomposition_Dest()
  {
    return (EReference)featureXORDecompositionEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EClass getFeatureORDecomposition()
  {
    return featureORDecompositionEClass;
  }
   ...
   * @generated
   */
  public EReference getFeatureORDecomposition_Dest()
  {
    return (EReference)featureORDecompositionEClass.getEStructuralFeatures().get(0);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(urNspecEClass, UR_NSPEC__FEATURE_MODELS);
    ...
    createEAttribute(featureElementEClass, FEATURE_ELEMENT__NAME);

    decomposedFeatureEClass = createEClass(DECOMPOSED_FEATURE);

    featureModelMainEClass = createEClass(FEATURE_MODEL_MAIN);
    createEAttribute(featureModelMainEClass, FEATURE_MODEL_MAIN__NAME);
    createEReference(featureModelMainEClass, FEATURE_MODEL_MAIN__LONG_NAME);
    createEReference(featureModelMainEClass, FEATURE_MODEL_MAIN__ROOT);

    noneFeatureEClass = createEClass(NONE_FEATURE);

    xorDecomposedFeatureEClass = createEClass(XOR_DECOMPOSED_FEATURE);
    createEReference(xorDecomposedFeatureEClass, XOR_DECOMPOSED_FEATURE__LINKS_SRC);

    orDecomposedFeatureEClass = createEClass(OR_DECOMPOSED_FEATURE);
    createEReference(orDecomposedFeatureEClass, OR_DECOMPOSED_FEATURE__LINKS_SRC);

    inclusionFeatureEClass = createEClass(INCLUSION_FEATURE);
    createEReference(inclusionFeatureEClass, INCLUSION_FEATURE__LINKS_SRC);

    inclusionEClass = createEClass(INCLUSION);
    createEAttribute(inclusionEClass, INCLUSION__INCLUSION_TYPE);
    createEReference(inclusionEClass, INCLUSION__DEST);

    featureXORDecompositionEClass = createEClass(FEATURE_XOR_DECOMPOSITION);
    createEReference(featureXORDecompositionEClass, FEATURE_XOR_DECOMPOSITION__DEST);

    featureORDecompositionEClass = createEClass(FEATURE_OR_DECOMPOSITION);
    createEReference(featureORDecompositionEClass, FEATURE_OR_DECOMPOSITION__DEST);
  ...
  public void initializePackageContents()
  {
    ...
    decomposedFeatureEClass.getESuperTypes().add(this.getFeatureElement());
    noneFeatureEClass.getESuperTypes().add(this.getFeatureElement());
    xorDecomposedFeatureEClass.getESuperTypes().add(this.getDecomposedFeature());
    orDecomposedFeatureEClass.getESuperTypes().add(this.getDecomposedFeature());
    inclusionFeatureEClass.getESuperTypes().add(this.getFeatureElement());
    ...
    initEReference(getURNspec_FeatureModels(), this.getFeatureModelMain(), null, "featureModels", null, 0, -1, URNspec.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getFeatureElement_Name(), ecorePackage.getEString(), "name", null, 0, 1, FeatureElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(decomposedFeatureEClass, DecomposedFeature.class, "DecomposedFeature", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(featureModelMainEClass, FeatureModelMain.class, "FeatureModelMain", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getFeatureModelMain_Name(), ecorePackage.getEString(), "name", null, 0, 1, FeatureModelMain.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getFeatureModelMain_LongName(), this.getLongName(), null, "longName", null, 0, 1, FeatureModelMain.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getFeatureModelMain_Root(), this.getFeatureElement(), null, "root", null, 0, 1, FeatureModelMain.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(noneFeatureEClass, NoneFeature.class, "NoneFeature", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(xorDecomposedFeatureEClass, XORDecomposedFeature.class, "XORDecomposedFeature", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getXORDecomposedFeature_LinksSrc(), this.getFeatureXORDecomposition(), null, "linksSrc", null, 0, -1, XORDecomposedFeature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(orDecomposedFeatureEClass, ORDecomposedFeature.class, "ORDecomposedFeature", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getORDecomposedFeature_LinksSrc(), this.getFeatureORDecomposition(), null, "linksSrc", null, 0, -1, ORDecomposedFeature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(inclusionFeatureEClass, InclusionFeature.class, "InclusionFeature", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getInclusionFeature_LinksSrc(), this.getInclusion(), null, "linksSrc", null, 0, -1, InclusionFeature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(inclusionEClass, Inclusion.class, "Inclusion", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getInclusion_InclusionType(), this.getInclusionType(), "inclusionType", null, 0, 1, Inclusion.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getInclusion_Dest(), this.getFeatureElement(), null, "dest", null, 0, 1, Inclusion.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(featureXORDecompositionEClass, FeatureXORDecomposition.class, "FeatureXORDecomposition", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getFeatureXORDecomposition_Dest(), this.getFeatureElement(), null, "dest", null, 0, 1, FeatureXORDecomposition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(featureORDecompositionEClass, FeatureORDecomposition.class, "FeatureORDecomposition", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getFeatureORDecomposition_Dest(), this.getFeatureElement(), null, "dest", null, 0, 1, FeatureORDecomposition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    addEEnumLiteral(inclusionTypeEEnum, InclusionType.MANDATORY);
    addEEnumLiteral(inclusionTypeEEnum, InclusionType.OPTIONAL);
