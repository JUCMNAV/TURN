...
public class TurnSemanticSequencer extends XbaseSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == TurnPackage.eINSTANCE)
			...
			case TurnPackage.FAILURE_POINT:
				...
				return; 
			case TurnPackage.FEATURE_MODEL_MAIN:
				sequence_FeatureModelMain(context, (FeatureModelMain) semanticObject); 
				return; 
			case TurnPackage.FEATURE_OR_DECOMPOSITION:
				sequence_FeatureORDecomposition(context, (FeatureORDecomposition) semanticObject); 
				return; 
			case TurnPackage.FEATURE_XOR_DECOMPOSITION:
				sequence_FeatureXORDecomposition(context, (FeatureXORDecomposition) semanticObject); 
				return; 
			case TurnPackage.IN_BINDING:
				sequence_InBinding(context, (InBinding) semanticObject); 
				return; 
			case TurnPackage.INCLUSION:
				sequence_Inclusion(context, (Inclusion) semanticObject); 
				return; 
			case TurnPackage.INCLUSION_FEATURE:
				sequence_InclusionFeature(context, (InclusionFeature) semanticObject); 
				return; 
			...
			case TurnPackage.METADATA:
				...
				return; 
			case TurnPackage.NONE_FEATURE:
				sequence_NoneFeature(context, (NoneFeature) semanticObject); 
				return; 
			case TurnPackage.OR_DECOMPOSED_FEATURE:
				sequence_ORDecomposedFeature(context, (ORDecomposedFeature) semanticObject); 
				return; 
			...
			case TurnPackage.WAITING_PLACE:
				...
				return; 
			case TurnPackage.XOR_DECOMPOSED_FEATURE:
				sequence_XORDecomposedFeature(context, (XORDecomposedFeature) semanticObject); 
				return; 
			}
	...
	/**
	 * Contexts:
	 *     FeatureModelMain returns FeatureModelMain
	 *
	 * Constraint:
	 *     (name=QualifiedName longName=LongName root=FeatureElement)
	 */
	protected void sequence_FeatureModelMain(ISerializationContext context, FeatureModelMain semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TurnPackage.Literals.FEATURE_MODEL_MAIN__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TurnPackage.Literals.FEATURE_MODEL_MAIN__NAME));
			if (transientValues.isValueTransient(semanticObject, TurnPackage.Literals.FEATURE_MODEL_MAIN__LONG_NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TurnPackage.Literals.FEATURE_MODEL_MAIN__LONG_NAME));
			if (transientValues.isValueTransient(semanticObject, TurnPackage.Literals.FEATURE_MODEL_MAIN__ROOT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TurnPackage.Literals.FEATURE_MODEL_MAIN__ROOT));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getFeatureModelMainAccess().getNameQualifiedNameParserRuleCall_1_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getFeatureModelMainAccess().getLongNameLongNameParserRuleCall_2_0(), semanticObject.getLongName());
		feeder.accept(grammarAccess.getFeatureModelMainAccess().getRootFeatureElementParserRuleCall_4_0(), semanticObject.getRoot());
		feeder.finish();
	}
	...
	/**
	 * Contexts:
	 *     FeatureORDecomposition returns FeatureORDecomposition
	 *
	 * Constraint:
	 *     dest=FeatureElement
	 */
	protected void sequence_FeatureORDecomposition(ISerializationContext context, FeatureORDecomposition semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TurnPackage.Literals.FEATURE_OR_DECOMPOSITION__DEST) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TurnPackage.Literals.FEATURE_OR_DECOMPOSITION__DEST));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getFeatureORDecompositionAccess().getDestFeatureElementParserRuleCall_1_0(), semanticObject.getDest());
		feeder.finish();
	}
	...
	/**
	 * Contexts:
	 *     FeatureXORDecomposition returns FeatureXORDecomposition
	 *
	 * Constraint:
	 *     dest=FeatureElement
	 */
	protected void sequence_FeatureXORDecomposition(ISerializationContext context, FeatureXORDecomposition semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TurnPackage.Literals.FEATURE_XOR_DECOMPOSITION__DEST) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TurnPackage.Literals.FEATURE_XOR_DECOMPOSITION__DEST));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getFeatureXORDecompositionAccess().getDestFeatureElementParserRuleCall_1_0(), semanticObject.getDest());
		feeder.finish();
	}
	...
	/**
	 * Contexts:
	 *     FeatureElement returns InclusionFeature
	 *     InclusionFeature returns InclusionFeature
	 *
	 * Constraint:
	 *     (name=QualifiedName linksSrc+=Inclusion*)
	 */
	protected void sequence_InclusionFeature(ISerializationContext context, InclusionFeature semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Contexts:
	 *     Inclusion returns Inclusion
	 *
	 * Constraint:
	 *     (inclusionType=InclusionType dest=FeatureElement)
	 */
	protected void sequence_Inclusion(ISerializationContext context, Inclusion semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TurnPackage.Literals.INCLUSION__INCLUSION_TYPE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TurnPackage.Literals.INCLUSION__INCLUSION_TYPE));
			if (transientValues.isValueTransient(semanticObject, TurnPackage.Literals.INCLUSION__DEST) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TurnPackage.Literals.INCLUSION__DEST));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getInclusionAccess().getInclusionTypeInclusionTypeEnumRuleCall_0_0(), semanticObject.getInclusionType());
		feeder.accept(grammarAccess.getInclusionAccess().getDestFeatureElementParserRuleCall_1_0(), semanticObject.getDest());
		feeder.finish();
	}
	...
	/**
	 * Contexts:
	 *     FeatureElement returns NoneFeature
	 *     NoneFeature returns NoneFeature
	 *
	 * Constraint:
	 *     name=QualifiedName
	 */
	protected void sequence_NoneFeature(ISerializationContext context, NoneFeature semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TurnPackage.Literals.FEATURE_ELEMENT__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TurnPackage.Literals.FEATURE_ELEMENT__NAME));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getNoneFeatureAccess().getNameQualifiedNameParserRuleCall_0(), semanticObject.getName());
		feeder.finish();
	}
	...
	/**
	 * Contexts:
	 *     FeatureElement returns ORDecomposedFeature
	 *     DecomposedFeature returns ORDecomposedFeature
	 *     ORDecomposedFeature returns ORDecomposedFeature
	 *
	 * Constraint:
	 *     (name=QualifiedName linksSrc+=FeatureORDecomposition*)
	 */
	protected void sequence_ORDecomposedFeature(ISerializationContext context, ORDecomposedFeature semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Contexts:
	 *     FeatureElement returns XORDecomposedFeature
	 *     DecomposedFeature returns XORDecomposedFeature
	 *     XORDecomposedFeature returns XORDecomposedFeature
	 *
	 * Constraint:
	 *     (name=QualifiedName linksSrc+=FeatureXORDecomposition*)
	 */
	protected void sequence_XORDecomposedFeature(ISerializationContext context, XORDecomposedFeature semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
