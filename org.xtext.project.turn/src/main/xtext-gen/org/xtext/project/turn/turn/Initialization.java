 ...
 *   <li>{@link org.xtext.project.turn.turn.Initialization#getValue <em>Value</em>}</li>
 * </ul>
 *
...
public interface Initialization extends EObject
{
  ...
  /**
   * Sets the value of the '{@link org.xtext.project.turn.turn.Initialization#getVariable <em>Variable</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setValue(String)
   * @see org.xtext.project.turn.turn.TurnPackage#getInitialization_Value()
   * @model
   * @generated
   */
  String getValue();
  ...
  /**
   * Sets the value of the '{@link org.xtext.project.turn.turn.Initialization#getValue <em>Value</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
